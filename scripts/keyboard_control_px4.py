...
def __init__():
	...
	print("Initialized")
def RCInOverride(channel0,channel1,channel2,channel3):   #用于各通道赋值的函数
...
def action_control():
	...
	cur_target_rc_yaw = RCInOverride(channel0,channel1,channel2,channel3)  #给通道赋值
	if key == 'h' or key == 'H':
...
if __name__=="__main__":
	...
	print (msg)
	__init__()
	cur_target_rc_yaw = RCInOverride(1500,1500,1000,1500)   #初始值，即各通道都在中位
	while(1):
		key= getKey()
		command_control()
		action_control()
